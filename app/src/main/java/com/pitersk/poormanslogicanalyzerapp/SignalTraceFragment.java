...
/**
 * Created by piter on 2017-05-24.
 */
...
public class SignalTraceFragment extends Fragment {
    ...
    private MultipleTraceView mMultipleTraceView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_signal_trace, container, false);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Constants.MESSAGE_STATE_CHANGE:
                    switch (msg.arg1) {
                        case BluetoothConnectionService.STATE_CONNECTED:
                            ...
                            //BluetoothConnectionService.clear();
                            break;
                ...
                case Constants.MESSAGE_READ:
                    ...
                    mMultipleTraceView.setSignalTraces(readBuf);
